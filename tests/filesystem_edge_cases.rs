...
mod macos_specific_tests {
    ...
    fn test_case_sensitivity_behavior() {
        ...
        file1.write_all(b"content1").expect("Failed to write to file1");
        
        // On case-insensitive systems, this should overwrite
        let mut file2 = File::create(&file2_path).expect("Failed to create file2");
        file2.write_all(b"content2").expect("Failed to write to file2");
        ...
        read_file.read_to_string(&mut content).expect("Failed to read file1");
    ...
    fn test_special_macos_files() {
        ...
        assert!(apple_double_exists, "Should be able to create AppleDouble files");
    }
    ...
    fn test_apfs_specific_behavior() {
        ...
        file.write_all(&zero_block).expect("Failed to write large file");
...
mod cross_platform_tests {
    ...
    fn test_concurrent_file_access() {
        ...
        file1.write_all(b"initial content").expect("Failed to write initial content");
        ...
        println!("  Can read while write handle open: {}", can_read_concurrent);
        ...
        println!("  Can write after closing previous handle: {}", can_write_after_close);
