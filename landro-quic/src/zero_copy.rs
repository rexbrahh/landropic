...
impl ZeroCopyFileReader {
    ...
    pub async fn read_chunks_vectored(
        &self,
        offsets: &[(u64, usize)],
    ) -> Result<Vec<Bytes>> {
...
mod linux {
    ...
    pub fn sendfile(out_fd: RawFd, in_fd: RawFd, offset: Option<&mut i64>, count: usize) -> io::Result<usize> {
...
mod tests {
    ...
    async fn test_zero_copy_file_reader() {
        ...
        // Test reading
        let reader = ZeroCopyFileReader::new(temp_file.path(), 1024).await.unwrap();
